...
export default async function Comments({
  ...
  const filter =
    status && ["PENDING", "APPROVED", "HIDDEN"].includes(status)
      ...
      : undefined;
  const items = await db.programComment.findMany({
      ...
      <AdminHeader
        ...
        actions={
          <div className="table-actions">
            ...
            <a className="btn btn-outline btn-sm" href="/admin/comments?status=APPROVED">
              المعتمدة
            </a>
            <a className="btn btn-outline btn-sm" href="/admin/comments?status=HIDDEN">
              المخفية
            </a>
          </div>
        }
            ...
            {items.map((i) => (
              <tr key={i.id}>
                ...
                <td className="table-actions">
                  ...
                  <form action={moderateCommentAction.bind(null, i.id, "DELETE")}>
