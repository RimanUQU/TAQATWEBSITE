...
export default async function HomePage() {
  ...
  return <><HeroSlider slides={slides} />
    ...
    {settings.showTestimonials === "true" && <section className="page-section"><div className="container"><SectionTitle title={settings.testimonialsHeading} subtitle="قصص وتجارب نعتز بها من مجتمع طاقات." /><div className="grid-3">{testimonials.map((t) => <TestimonialCard key={t.id} item={t} />)}</div></div></section>}
  </>;
}
