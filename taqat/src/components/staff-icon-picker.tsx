  ...
  return (
    <div className="field full">
      ...
      <div className="staff-icon-picker">
        <div className="staff-icon-preview" aria-hidden="true">
          {selected ? <img src={selected} alt="" /> : <span>ط</span>}
        </div>
        <select
          id={id}
          name="icon"
      ...
      <small>
        {icons.length
          ? "تظهر ملفات SVG الموجودة في public/staff-icons تلقائيًا هنا."
          : "أضيفي ملفات SVG إلى public/staff-icons لتظهر هنا تلقائيًا."}
      </small>
    </div>
  );
}
